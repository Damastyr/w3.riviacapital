...
"%DIR_ENCODER%\w3speech.exe" --pack-w3speech "%DIR_AUDIO_WEM%" --output-dir "%DIR_DLC_CONTENT%" --script-prefix "%MODNAME_LC%" --script-output-dir "%DIR_TMP_MOD_SCRIPTS%\local" --strings-file "%DIR_STRINGS%\strings.custom.speech.csv" --language %language% %loglevel%
